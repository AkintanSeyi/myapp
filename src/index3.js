...
contact form
 ...
 <img src={"./web-port-img/images__5_-removebg-preview.png"} alt="" className="first-section__img1" />
...
<div  className="first-section__main">
  ...
  <div data-aos="zoom-in" className="first-section__set">
    ...
    <p className="first-section__p1">No code App Developer</p>
...
<div data-aos="zoom-in"  className="third-section__div">
  <p ref={D} className="third-section__p">
   hello, i'm a fullstack web developer and No code App Developer from lagos state, Nigeria West Africa .
   i love coding and solving problems.
   i journey started from web deverlopment in 2017 and i have always tried to improve from then, i have helped client and organizations improve there businesses through e.g improving there user interface , make api fetching faster , easy flow of the website or App, Fixing of clients problems. i'm a top rated freelancer on Fiverr and Upwork with a lot of experience working for organizations and clients from around the world . i have taken a lot of courses online and
   mastered a lot of coding skills (html,css, javascript, react js, redux, tailwindcss, mui,  express js, node js, moongodb etc) and No code skills like (Bubble, Flutterflow, Adalo,  wix , shopify, woocommerce).
