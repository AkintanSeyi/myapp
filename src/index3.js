      ...
      <section className="section">
        ...
        <div ref={A} className="first-section">
          <section className="first-section__holder">
            ...
            <img
              src={require("../src/web-port-img/icons8-html-5-480.png")}
              alt="img"
              className="first-section__img"
            />
            <img
              src={require("../src/web-port-img/icons8-css3-480.png")}
              alt="img"
              className="first-section__img1"
            />
            <img
              src={require("../src/web-port-img/icons8-javascript-480.png")}
              alt=""
              className="first-section__img2"
            />
            <img
              src={require("../src/web-port-img/icons8-react-480.png")}
              alt=""
              className="first-section__img3"
            />
            <img
              src={require("../src/web-port-img/icons8-node-js-240.png")}
              alt=""
              className="first-section__img4"
            />
            <div className="first-section__main">
              <h2 data-aos="zoom-in" className="first-section__h2">
                patricia-son
              </h2>

              <div data-aos="zoom-in" className="first-section__set">
                <p className="first-section__p1">Full stack Web Developer</p>
                <p className="first-section__p1">Mobile App Developer </p>
              </div>
              <div className="first-section__icon-hol"></div>
              <p ref={C} className="first-section__p4">
          ...
          <section className="second-section__holder">
            <div className="second-section__2">
              <div data-aos="fade-down" className="second-section__2-head">
                <h2 className="second-section__h2">skills</h2>
                <h3 className="second-section__h3">skills</h3>
              </div>
        ...
        <div ref={F} className="third-section">
          <section className="third-section__holder">
            <div data-aos="fade-down" className="third-section__1">
              <h2 className="third-section__h2">about me</h2>
        ...
        <div ref={G} className="fourth-section">
          <section className="fourth-section__holder">
            <div data-aos="fade-down" className="third-section__1">
              <h2 className="third-section__h2">Portifolio</h2>
              <div className="third-section__line "></div>
            </div>
                    ...
                    <section className="fourth-section__set-holder">
                      <div data-aos="fade-right" className="fourth-section__1">
                        <section className="fourth-section__1-holder">
                          <img
                            src={require(`../src/web-port-img/` + image)}
                            alt="img"
                            className="fourth-section__img"
                          />

                          <button className="fourth-section__1-p">
                            <a href={web} className="fourth-section__link2">
                              visit web{" "}
                            </a>
                          </button>
                        </section>
                      ...
                      <div className="fourth-section__2">
                        ...
                        <div className="fourth-section__but-holder">
                          ...
                          >
                            <nav>
                              <a href={git} className="fourth-section__link2">
                                visit github
                              </a>
                            </nav>
                          </button>
        ...
        <div ref={H} className="contact">
          <section className="contact__holder">
            <div className="contact__icon-hold">
              ...
              >
                {" "}
                <FaLinkedin data-aos="fade-down" className="contact__icon">
                  {" "}
                </FaLinkedin>
              </a>
            ...
            <div
              ...
              className="third-section__1"
            >
              <h2 className="third-section__h2">contact form</h2>
              <div className="third-section__line "></div>
            </div>
